...
if (reviewerTextInput) {
  reviewerTextInput.addEventListener('input', () => {
    ...
    validateField(reviewerTextInput, 'text-error-msg', 'Please enter your review text (minimum 10 characters).', 10);
    updateLivePreview();
  });
}
...
if (reviewerNameInput) {
  reviewerNameInput.addEventListener('input', () => {
    validateField(reviewerNameInput, 'name-error-msg', 'Your name must be at least 2 characters long.', 2);
    updateLivePreview();
  });
}
...
function validateField(inputElement, errorElementId, errorMsg, minLength = 1) {
...
if (reviewForm) {
  reviewForm.addEventListener('submit', async (e) => {
    ...
    const isNameValid = validateField(reviewerNameInput, 'name-error-msg', 'Your name must be at least 2 characters long.', 2);
    const isTextValid = validateField(reviewerTextInput, 'text-error-msg', 'Please enter your review text (minimum 10 characters).', 10);
